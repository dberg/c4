...
inline ::c4::Response_ResponseCode Response::code() const {
  // @@protoc_insertion_point(field_get:c4.Response.code)
...
inline void Response::set_code(::c4::Response_ResponseCode value) {
  ...
  set_has_code();
  code_ = value;
  // @@protoc_insertion_point(field_set:c4.Response.code)
}
...
inline const ::std::string& Response::body() const {
  // @@protoc_insertion_point(field_get:c4.Response.body)
  return *body_;
}
inline void Response::set_body(const ::std::string& value) {
  ...
  body_->assign(value);
  // @@protoc_insertion_point(field_set:c4.Response.body)
}
inline void Response::set_body(const char* value) {
  ...
  body_->assign(value);
  // @@protoc_insertion_point(field_set_char:c4.Response.body)
}
inline void Response::set_body(const char* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:c4.Response.body)
}
inline ::std::string* Response::mutable_body() {
  ...
  // @@protoc_insertion_point(field_mutable:c4.Response.body)
  return body_;
}
...
inline void Response::set_allocated_body(::std::string* body) {
  ...
  // @@protoc_insertion_point(field_set_allocated:c4.Response.body)
}
...
template <> struct is_proto_enum< ::c4::Response_ResponseCode> : ::google::protobuf::internal::true_type {};
template <>
