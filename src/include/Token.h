...
enum Token {
  ...
  TOK_INTEGER_TYPE_SUFFIX = -25, // 'l' or 'L'
  TOK_BOOLEAN_LITERAL = -26,
  TOK_NULL_LITERAL = -27,

  // Numbers
  TOK_DECIMAL_NUMERAL = -28,
  TOK_DECIMAL_NUMERAL_WITH_INT_TYPE_SUFFIX = -29,
  ...
  TOK_KEY_GOTO = -51,
  TOK_KEY_IF = -52,
  TOK_KEY_IMPLEMENTS = -53,
  TOK_KEY_IMPORT = -54,
  TOK_KEY_INSTANCEOF = -55,
  TOK_KEY_INT = -56,
  TOK_KEY_INTERFACE = -57,
  TOK_KEY_LONG = -58,
  TOK_KEY_NATIVE = -59,
  TOK_KEY_NEW = -60,
  TOK_KEY_PACKAGE = -61,
  TOK_KEY_PRIVATE = -62,
  TOK_KEY_PROTECTED = -63,
  TOK_KEY_PUBLIC = -64,
  TOK_KEY_RETURN = -65,
  TOK_KEY_SHORT = -66,
  TOK_KEY_STATIC = -67,
  ...
  TOK_KEY_SUPER = -69,
  TOK_KEY_SWITCH = -70,
  TOK_KEY_SYNCHRONIZED = -71,
  TOK_KEY_THIS = -72,
  TOK_KEY_THROW = -73,
  TOK_KEY_THROWS = -74,
  TOK_KEY_TRANSIENT = -75,
  TOK_KEY_TRY = -76,
  TOK_KEY_VOID = -77,
  TOK_KEY_VOLATILE = -78,
  TOK_KEY_WHILE = -79,
