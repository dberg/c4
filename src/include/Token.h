...
enum Token {
  ...
  TOK_DECIMAL_FLOATING_POINT_LITERAL = -64,
  TOK_HEXADECIMAL_FLOATING_POINT_LITERAL = -65,
  ...
  TOK_KEY_GOTO = -87,
  TOK_KEY_IF = -88,
  TOK_KEY_IMPLEMENTS = -89,
  TOK_KEY_IMPORT = -90,
  TOK_KEY_INSTANCEOF = -91,
  TOK_KEY_INT = -92,
  TOK_KEY_INTERFACE = -93,
  TOK_KEY_LONG = -94,
  TOK_KEY_NATIVE = -95,
  TOK_KEY_NEW = -96,
  TOK_KEY_PACKAGE = -97,
  TOK_KEY_PRIVATE = -98,
  TOK_KEY_PROTECTED = -99,
  TOK_KEY_PUBLIC = -100,
  TOK_KEY_RETURN = -101,
  TOK_KEY_SHORT = -102,
  TOK_KEY_STATIC = -103,
  TOK_KEY_STRICTFP = -104,
  TOK_KEY_SUPER = -105,
  TOK_KEY_SWITCH = -106,
  TOK_KEY_SYNCHRONIZED = -107,
  TOK_KEY_THIS = -108,
  TOK_KEY_THROW = -109,
  TOK_KEY_THROWS = -110,
  TOK_KEY_TRANSIENT = -111,
  TOK_KEY_TRY = -112,
  TOK_KEY_VOID = -113,
  TOK_KEY_VOLATILE = -114,
  TOK_KEY_WHILE = -115,
};
