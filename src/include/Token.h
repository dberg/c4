...
enum Token {
  ...
  // Numbers
  TOK_DECIMAL_NUMERAL = -58,
  TOK_DECIMAL_NUMERAL_WITH_INT_TYPE_SUFFIX = -59,
  TOK_HEX_NUMERAL = -60,
  TOK_HEX_NUMERAL_WITH_INT_TYPE_SUFFIX = -61,
  TOK_OCTAL_NUMERAL = -62,
  TOK_OCTAL_NUMERAL_WITH_INT_TYPE_SUFFIX = -63,
  TOK_BINARY_NUMERAL = -64,
  TOK_BINARY_NUMERAL_WITH_INT_TYPE_SUFFIX = -65,

  TOK_DECIMAL_FLOATING_POINT_LITERAL = -66,
  TOK_HEXADECIMAL_FLOATING_POINT_LITERAL = -67,
  ...
  TOK_KEY_GOTO = -89,
  TOK_KEY_IF = -90,
  TOK_KEY_IMPLEMENTS = -91,
  TOK_KEY_IMPORT = -92,
  TOK_KEY_INSTANCEOF = -93,
  TOK_KEY_INT = -94,
  TOK_KEY_INTERFACE = -95,
  TOK_KEY_LONG = -96,
  TOK_KEY_NATIVE = -97,
  TOK_KEY_NEW = -98,
  TOK_KEY_PACKAGE = -99,
  TOK_KEY_PRIVATE = -100,
  TOK_KEY_PROTECTED = -101,
  TOK_KEY_PUBLIC = -102,
  TOK_KEY_RETURN = -103,
  TOK_KEY_SHORT = -104,
  TOK_KEY_STATIC = -105,
  TOK_KEY_STRICTFP = -106,
  TOK_KEY_SUPER = -107,
  TOK_KEY_SWITCH = -108,
  TOK_KEY_SYNCHRONIZED = -109,
  TOK_KEY_THIS = -110,
  TOK_KEY_THROW = -111,
  TOK_KEY_THROWS = -112,
  TOK_KEY_TRANSIENT = -113,
  TOK_KEY_TRY = -114,
  TOK_KEY_VOID = -115,
  TOK_KEY_VOLATILE = -116,
  TOK_KEY_WHILE = -117,
};
